<div class="row"
				style="background-color: #B65881; margin-bottom:0px; padding-left:20px; padding-right:20px; bottom:0;fixed:100px;">
				...
				<div class="col-md-4">
					<h2>Services</h2>
					<p>
						Retail and Consumer Banking <br>Personal Internet Banking <br>Corporate
						Internet Banking<br> Debit and Credit Cards
					</p>
				</div>
				<div class="col-md-4">
					<h2>Contact Us</h2>
